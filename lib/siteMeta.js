...
export const siteTitle = "Eduardo Rocha — Desenvolvedor de Software Focado em IA";
export const siteDescription =
  "Blog de Eduardo Rocha, desenvolvedor focado em IA. Artigos em português sobre inteligência artificial, LLMs, agentes autônomos e engenharia de software.";
